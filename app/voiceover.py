...
VOICE_MAP = {
    Topic.FINANCE: "en-US-ChristopherNeural",
    Topic.RELATIONSHIPS: "en-US-GuyNeural",
    Topic.HEALTH: "en-US-AriaNeural",
    Topic.CULTURE: "en-GB-SoniaNeural",
}
...
def _voice_id_for_topic(topic: Topic) -> str:
    return VOICE_MAP.get(topic, "en-US-ChristopherNeural")
...
def synthesize_voiceover(script_payload: dict, topic: Topic, reel_id: str) -> tuple[str, str]:
    ...
    vtt_path = output_dir / f"{reel_id}_voice.vtt"
